...
export const CONTACT_ROLE_OPTIONS: ContactRoleConfig[] = [
  {
    ...
    label: 'Client',
    pluralLabel: 'Clients',
    selectLabel: 'Client (Owner Paying Retainers)',
    detailLabel: 'Client (Owner)',
  ...
  },
  {
    ...
    label: 'Vendor',
    pluralLabel: 'Vendors',
    selectLabel: 'Vendor (Installer / Service Provider)',
    detailLabel: 'Vendor / Service Provider',
  ...
  },
  {
    ...
    selectLabel: 'Material Supplier (Stone, Wood, Tile)',
    detailLabel: 'Material Supplier',
  ...
  },
  {
    ...
    selectLabel: 'Contractor (Trade / Subcontract Work)',
  ...
  },
  {
    ...
    selectLabel: 'Site Worker (Crew Member)',
    detailLabel: 'Site Worker / Crew',
  ...
  },
  {
    ...
    label: 'Other',
    pluralLabel: 'Other',
    selectLabel: 'Other Contact',
    detailLabel: 'Other Contact',
